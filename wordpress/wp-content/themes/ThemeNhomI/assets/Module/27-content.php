...
<div class="type-389">
  <header>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <a href="https://shtheme.com/demosd/travelguidewp/" id="logo">
                       <img src="<?php echo get_template_directory_uri() ?>/assets/images/logo_login.png?>" width="170" height="30" alt="" data-retina="true"></a>
                </div>
                <div class="col-sm-8">
    ...
    <div class="container margin_30">
        <div class="row">
            <div class="col-md-12">
                  <p><img src="<?php echo get_template_directory_uri() ?>/assets/images/bg_login1.png?>" width="377" height="150" alt="" class="img-responsive" style="margin:auto;">
                  </p>
            </div>
        </div>
